! function() {
    var e = {
            ...
            147: function(e, t, o) {
                ...
                }, y.call(m.prototype), y.call(_.prototype), _.prototype.clone = function() {
    ...
    o.d = function(e, t) {
        ...
        function() {
            if (! function() {
                    try {
                        const e = {
                                registeredDomain: "tresmarescapital.com",
            ...
            if (!!(!window.cookieyes || !window.cookieyes._ckyStore)) {
                ...
                o._ckyGetCookieMap = function() {
                    ...
                    _categories: [{
                        ...
                        cookies: [{
                            cookieID: "PHPSESSID",
                            domain: "www.tresmarescapital.com"
                        }, {
                    ...
                    _rootDomain: "tresmarescapital.com",
                    _commonShortCodes: [{
                        key: "cky_audit_table",
                        content: {
                ...
                ["consentid", "consent", "action"].concat(o._ckyStore._categories.map((e => {
                        ...
                        try {
                            const r = {
                                ...
                                n = new FormData;
                            n.append("key", "649e9a5e7b29101bdb76c15c"), n.append("request_type", e), n.append("event_log_time", Math.round(Date.now() / 1e3)), n.append("payload", JSON.stringify(r)), navigator.sendBeacon("https://log.cookieyes.com/api/v1/log", n)
                        } catch (e) {
                            console.error(e)
                        }
                    },
                ...
                i.src = "https://cdn-cookieyes.com/client_data/649e9a5e7b29101bdb76c15c/banner.js", i.async = !0, i.id = "cookieyes-banner", document.head.appendChild(i)
            }
        }()
}()